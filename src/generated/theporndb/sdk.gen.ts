...
import type {
  ...
  GetPerformerSiteData,
  GetPerformerSiteResponses,
  GetPerformerSiteErrors,
  ListPerformersData,
 ...
 * Get PerformerSite
 */
export const getPerformerSite = <ThrowOnError extends boolean = false>(
  options: Options<GetPerformerSiteData, ThrowOnError>
) => {
  return (options.client ?? _heyApiClient).get<GetPerformerSiteResponses, GetPerformerSiteErrors, ThrowOnError>({
    security: [
      {
        name: 'Authorization',
        type: 'apiKey'

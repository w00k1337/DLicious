...
export type ListPerformerSitesData = {
  ...
  query?: {
     ...
     */
    q?: string
    orderBy?: PerformerSiteOrderEnum
    /**
     * The letter the name begins with
     */
    letter?: string
     ...
     */
    parent_id?: number
    parent_operation?: PerformerSiteParentOperationEnum
    /**
     * The site to filter by
     */
    site?: string
...
export type ListPerformerSitesResponses = {
  /**
   * List/Search PerformerSites
   */
  200: {
    /**
     * An array of PerformerSiteResource
     */
...
export type GetPerformerSiteData = {
  body?: never
  path: {
    /**
     * Identifier for this entity, can be slug, id or uuid
  ...
  query?: never
  url: '/performer-sites/{identifier}'
}

export type GetPerformerSiteErrors = {
  /**
   * Not Found
   */
  404: {
...
export type GetPerformerSiteError = GetPerformerSiteErrors[keyof GetPerformerSiteErrors]

export type GetPerformerSiteResponses = {
  /**
   * Get PerformerSite
   */
  200: {
    data?: PerformerSiteResource
  }
}

export type GetPerformerSiteResponse = GetPerformerSiteResponses[keyof GetPerformerSiteResponses]
